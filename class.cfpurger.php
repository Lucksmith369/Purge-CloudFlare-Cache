...
class Cfpurger {
	 ...
	 *
	 */
	const PAGE_TITILE = 'Purge CloudFlare Cache Settings';
	/**
	 *
	 */
	const PLUGIN_TITILE = 'Purge CloudFlare Cache';
	/**
	 *
	 */
	const MENU_TITILE = 'Purge CloudFlare Cache';
	/**
	 *
	 */
	...
	function sample_admin_notice_info() {
		...
		if ( isset( $_GET['page'] ) && $_GET['page'] == self::MENU_SLUG &&
			...
			<p><?php _e( 'You will need to enter your API key and Zone ID for your account first. You can
